...
### Build and Install
```
$ go get github.com/opentable/Burrow
$ cd $GOPATH/src/github.com/opentable/Burrow
$ gpm install
$ go install
```
...
### Configuration
For information on how to write your configuration file, check out the [detailed wiki](https://github.com/opentable/Burrow/wiki)
